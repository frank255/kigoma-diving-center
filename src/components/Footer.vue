<template>
    <div class="bg-gradient-to-r from-cyan-500 to-blue-500   px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          <span class="text-base font-bold tracking-wide text-gray-900">Subscribe for updates</span>
