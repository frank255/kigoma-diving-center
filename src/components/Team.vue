<template>
  <section id="team" class="py-6 bg-gray-800 text-gray-100">
    ...
    >
      <p
        class="p-4 text-3xl sm:text-5xl font-medium tracking-wider text-center text-[#A45C40]"
      >
        Meet Our team
      </p>
      ...
      <div class="flex flex-row flex-wrap-reverse justify-center mt-8">
        ...
        >
          ...
          <div
            class="flex items-center justify-center p-3 space-x-3 border-t-2"
          >
            <a
              rel="noopener noreferrer"
              v-bind:href="'mailto:' + team.email"
              title="Email"
            ...
            <a
              rel="noopener noreferrer"
              v-bind:href="
                'https://twitter.com/' + team.twitter + '?ref_src=twsrc%5Etfw'
              "
              title="Twitter"
              class="dark:text-gray-900 hover:dark:text-violet-400"
            >
            ...
            <a
              rel="noopener noreferrer"
              v-bind:href="'https://wa.me/' + team.whatsapp"
              title="Whatsapp"
              class="dark:text-gray-900 hover:dark:text-violet-400"
            >
              <svg
            ...
            <a
              rel="noopener noreferrer"
              v-bind:href="'https://www.instagram.com/' + team.instagram"
              title="Instagram"
              class="dark:text-gray-900 hover:dark:text-violet-400"
            >
              <svg
...
export default {
  ...
  mounted() {
    axios
      .get("https://api.kigomadivingcenter.com/api/team")
      .then((response) => {
