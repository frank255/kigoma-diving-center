			...
			<div class="flex flex-row flex-wrap-reverse justify-center mt-8">
				<div class="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800" v-for="team in teams" :key="team.id">
					...
					<div class="flex items-center justify-center p-3 space-x-3 border-t-2">
						<a rel="noopener noreferrer" v-bind:href=" 'mailto:' + team.email" title="Email" class="dark:text-gray-900 hover:dark:text-violet-400">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
								<path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
								<path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
							</svg>
						</a>
						<a rel="noopener noreferrer" v-bind:href="'https://twitter.com/' + team.twitter+ '?ref_src=twsrc%5Etfw'" title="Twitter" class="dark:text-gray-900 hover:dark:text-violet-400">
						...
						<a rel="noopener noreferrer" v-bind:href="'https://wa.me/' + team.whatsapp" title="Whatsapp" class="dark:text-gray-900 hover:dark:text-violet-400">
						...
						<a rel="noopener noreferrer" v-bind:href="'https://www.instagram.com/'+team.instagram" title="Instagram" class="dark:text-gray-900 hover:dark:text-violet-400">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="currentColor" class="w-5 h-5">
...
export default {
  ...
  mounted() {
    axios
      .get("http://kigomadivingcenter.x10.mx/api/team")
      .then((response) => {
