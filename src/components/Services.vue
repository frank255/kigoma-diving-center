...
<section class="text-gray-100 bg-gray-800  body-font">
  <div class="container px-5 py-10 mx-auto">
    <div class="text-center mb-20">
      <h1 class="title-font text-3xl mt-4 font-bold tracking-tight text-center sm:text-5xl text-[#A45C40] mb-4">Experience With Us..</h1>
    </div>
    <div class="flex flex-wrap sm:-m-4 -mx-4  -mt-4 md:space-y-0 space-y-6" >
      <div class="p-4 md:w-1/3 flex flex-col text-center items-center"  data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="500">
        ...
        <div class="flex-grow mb-10">
          ...
          <a href="/booking" class="mt-3 text-indigo-500 inline-flex items-center">Book Now
