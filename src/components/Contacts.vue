<template>
	<div id="contacts" class="container grid max-w-screen-xl  grid-cols-1 gap-8 px-8 py-40 mx-auto  md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-gray-800 text-gray-100 overflow-hidden">
