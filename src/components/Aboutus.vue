<template>
  <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
      <div>
        <p class="inline-block px-3 py-px mb-4 text-xl font-semibold tracking-wider text-green-300 uppercase rounded-full bg-teal-accent-400">
          About us
        </p>
      </div>
    ...
    <div class="text-center">
      <a
        href="/"
        class="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded-full shadow-lg md:w-auto bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
      >
        Let's Dive together
      </a>
    </div>
