<template>
  <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    ...
    <div class="text-center">
      <a
        href="/"
        class="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md md:w-auto bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
      >
        Let's Dive together
      </a>
    </div>
